    ...
    <section className="py-16 bg-neutral-950 relative overflow-hidden">
      <div className="relative z-10">
        <div className="container mx-auto px-4 relative">
          {/* Decorative elements */}
          <div className="absolute -right-20 top-20 size-72 bg-purple-500/20 rounded-full blur-3xl" />
          <div className="absolute -left-20 bottom-20 size-[500px] bg-blue-500/10 rounded-full blur-3xl" />
          ...
          <div className="grid grid-cols-12 gap-4 md:gap-6">
            ...
            <div className="col-span-12 md:col-span-8">
              <div className="bg-white/5 p-8 rounded-2xl border border-white/10 shadow-lg relative group overflow-hidden">
                <div className="relative z-10">
            ...
            <div className="relative col-span-12 md:col-span-4">
              <div className="relative bg-white/5 p-6 rounded-2xl border border-white/10 shadow-lg group overflow-hidden z-20 h-full">
                ...
                <h3 className="text-2xl font-bold text-white mb-2 z-20">
                  {t("feature2.title")}
                </h3>
            ...
            <div className="col-span-12 md:col-span-6">
              <div className="bg-white/5 p-6 rounded-2xl border border-white/10 shadow-lg relative h-full group overflow-hidden z-10">
            ...
            <div className="col-span-12 md:col-span-6">
              <div className="relative bg-gradient-to-br from-white/5 to-purple-500/10 p-6 rounded-2xl border h-full border-white/10 shadow-lg overflow-hidden z-10">
                ...
                <div className="flex justify-end mt-4">
                  <Button
                    className="z-10 text-lg font-semibold w-full h-16"
                    asChild
                  >
                    <Link href={`/${locale}/sign-up`}>{t("cta.button")}</Link>
                  </Button>
                </div>
              </div>
            </div>
